  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        pythoneda-artifact-application-pyproject-versioning-0_0_1a1-for =
      ...
      in rec {
        packages = rec {
          pythoneda-artifact-application-pyproject-versioning-0_0_1a1-python39 =
            pythoneda-artifact-application-pyproject-versioning-0_0_1a1-for {
              pythoneda-base =
          ...
          pythoneda-artifact-application-pyproject-versioning-0_0_1a1-python310 =
            pythoneda-artifact-application-pyproject-versioning-0_0_1a1-for {
              pythoneda-base =
        ...
        apps = rec {
          pythoneda-artifact-application-pyproject-versioning-0_0_1a1-python39 =
            shared.app-for {
              package =
                self.packages.${system}.pythoneda-artifact-application-pyproject-versioning-0_0_1a1-python39;
              inherit pname;
            };
          pythoneda-artifact-application-pyproject-versioning-0_0_1a1-python310 =
            shared.app-for {
              package =
                self.packages.${system}.pythoneda-artifact-application-pyproject-versioning-0_0_1a1-python310;
              inherit pname;
            };
          pythoneda-artifact-application-pyproject-versioning-latest-python39 =
            pythoneda-artifact-application-pyproject-versioning-0_0_1a1-python39;
        ...
        devShells = rec {
          pythoneda-artifact-application-pyproject-versioning-0_0_1a1-python39 =
            shared.devShell-for {
              package =
                packages.pythoneda-artifact-application-pyproject-versioning-0_0_1a1-python39;
              pythoneda-base =
                pythoneda-base.packages.${system}.pythoneda-base-latest-python39;
              python = pkgs.python39;
          ...
          pythoneda-artifact-application-pyproject-versioning-0_0_1a1-python310 =
            shared.devShell-for {
              package =
                packages.pythoneda-artifact-application-pyproject-versioning-0_0_1a1-python310;
              pythoneda-base =
                pythoneda-base.packages.${system}.pythoneda-base-latest-python310;
              python = pkgs.python310;
              inherit pkgs nixpkgsRelease;
